    ...
    <>
      ...
      <Table striped bordered hover className="mb-5" >
        ...
        {quizReports?.map((quizReport) => (
                    <tr>
        <td><Button  variant="success" onClick={()=>navigate('/test/'+id+'/report',{state:{score:quizReport.data.score,tq:quizReport.data.tq,questions:quizReport.data.questions,answers:quizReport.data.answers}})}><FontAwesomeIcon icon={solid('square-poll-horizontal')}/> Quiz-{quizReports.indexOf(quizReport)+1}</Button></td>
